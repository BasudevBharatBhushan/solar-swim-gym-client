                  ...
                  <Box sx={{ bgcolor: '#f1f5f9', p: { xs: 1, md: 4 }, borderRadius: 1 }}>
                    <Box
                      sx={{ 
                        ...
                        '& .ql-container.ql-snow': { border: 'none', fontFamily: 'inherit' },
                        '& .ql-editor': { padding: 0, height: 'auto', overflow: 'visible' },
                        '& .ql-align-justify': { textAlign: 'justify', textAlignLast: 'left' }
                      }}
                    >
                      <ReactQuill
